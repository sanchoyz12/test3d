...
for url_path in urls:
    ...
    req = urllib.request.Request(full_url, headers={'User-Agent': 'Mozilla'})
...
replacements = {
    # URLs
    "https://messenger.abeto.co/assets/dracoworker-9mmlh0V-.js": "`${client$1.absolutePath}/assets/dracoworker-9mmlh0V-.js`",
    "https://messenger.abeto.co/assets": "/assets",
